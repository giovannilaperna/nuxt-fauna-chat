...
export default {
  ...
  computed: {
    chatWindowTitle() {
      ...
      if (this.participants.length === 0) return this.$t('chat.you')
      if (this.participants.length > 1) return this.$t('chat.you') +', ' + this.participants[0].name

      return this.$t('chat.you') + ' & ' + this.participants[0].name
    }
  },
  methods: {
    openAndFocus() {
